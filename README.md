...
Repository pubblico per la distribuzione degli aggiornamenti di **TaoGEST** (Gestione Terapia Anticoagulante Orale).
...
- Calcolo del TTR (Time in Therapeutic Range)
- Gestione delle interazioni farmacologiche
- Pianificazione della bridge therapy per interventi chirurgici
- Supporto per lo switch a/da DOAC
- Esportazione PDF dei report

## Requisiti di sistema

- Windows 10/11 (64-bit)
- .NET 8.0 Runtime (incluso nell'installer)
